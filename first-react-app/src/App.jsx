      ...
      {isCardSelected ? (
        ...
        (
          ...
          <div className="wrapper">
            ...
            <h2
              className=" lg:text-4xl font-extrabold tracking-wide text-indigo-600 dark:text-indigo-400 sm:text-4xl"
              >
              Trending{" "}
              ...
              <section className="trending">
                <ul className="overflow-y-hidden">
                  {trendingMovies.map((movie, index) => (
                    <li onClick={() => console.log(movie)} className="transition-all hover:scale-110 cursor-pointer active:scale-100" key={movie.$id}>
                      <p>{index + 1}</p>
